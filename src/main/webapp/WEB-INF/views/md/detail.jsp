      ...
      <body>
        <div class="container">
          ...
          <div class="iframebox">
            <!-- 후기 페이지 -->
            <div id="review_list">
              <iframe src="${pageContext.request.contextPath}/mdreview/review_list?md_id=${md_id}" width="100%"
            ...
            <div id="exchange_list">
              <iframe src="${pageContext.request.contextPath}/mdreview/exchange" width="100%" height=700px frameborder=0
